...
public class TaskQueryParams extends TaskIdParams{
    ...
    public static TaskQueryParams newInstance(String taskId, Integer historyLength) {
        TaskQueryParams taskQueryParams = new TaskQueryParams();
        taskQueryParams.setId(taskId);
        taskQueryParams.setHistoryLength(historyLength);
        return taskQueryParams;
    }
    public static TaskQueryParams newInstance(String taskId) {
      return newInstance(taskId, null);
    }
}
