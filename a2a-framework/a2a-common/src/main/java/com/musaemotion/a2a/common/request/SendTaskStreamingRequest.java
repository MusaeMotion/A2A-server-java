...
public class SendTaskStreamingRequest extends JSONRPCRequest<TaskSendParams> {
    public static final String METHOD_PATH = "tasks/sendSubscribe";

    public SendTaskStreamingRequest() {
        this.setMethod(METHOD_PATH);
    }
     ...
     * @return
     */
    public static SendTaskStreamingRequest newInstance(TaskSendParams taskSendParams) {
        SendTaskStreamingRequest request = new SendTaskStreamingRequest();
        request.setParams(taskSendParams);
        request.setId(GuidUtils.createShortRandomGuid());
        return request;
    }
}
