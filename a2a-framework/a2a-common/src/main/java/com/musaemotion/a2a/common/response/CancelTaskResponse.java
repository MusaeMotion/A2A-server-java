...
public class CancelTaskResponse extends JSONRPCResponse<Task> {
   ...
   * @return
   */
  public static CancelTaskResponse buildTaskNotFoundError(String id) {
    CancelTaskResponse response = new CancelTaskResponse();
    return buildTaskNotFoundError(response, id);
  }
   ...
   * @return
   */
  public static CancelTaskResponse buildTaskNotCancelableError(String id) {
    CancelTaskResponse response = new CancelTaskResponse();
